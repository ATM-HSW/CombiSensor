...
class WifiManager:
    ...
    def setup_network(cls) -> bool:
        ...
        for new_connection in candidates:
            ...
            wifi.radio.connect(ssid=new_connection["ssid"], password=new_connection["password"]) #, bssid=new_connection["bssid"])
        ...
        return wifi.radio.ap_info != None
